...
public class MarketDataInit {
    ...
    public void makeBaseOrders() {
        ...
        com.back.boundedContext.market.domain.Order order1 = marketFacade.createOrder(cart1).data();
        com.back.boundedContext.market.domain.Order order2 = marketFacade.createOrder(cart2).data();
        com.back.boundedContext.market.domain.Order order3 = marketFacade.createOrder(cart3).data();
